        ...
        <div className="mx-auto max-w-7xl flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          ...
          <div className="w-full sm:max-w-lg flex items-center gap-2">
            <div className="flex-1">
              <SearchBar placeholder="Search by exam, commission (UPSC, SSC, BPSC), or post..." />
            </div>
            {params.search && (
              <Link
                href="/admit-cards"
                ...
                <table className="w-full text-left text-xs border-collapse">
                  <thead>
                    <tr className="bg-slate-50/80 border-b border-slate-200 text-[11px] font-bold text-slate-600 uppercase tracking-wider">
                      <th className="py-2.5 px-4">Authority &amp; Examination</th>
                      <th className="py-2.5 px-4">State / Jurisdiction</th>
                      <th className="py-2.5 px-4">Status</th>
                      <th className="py-2.5 px-4 text-right">Official Download</th>
                    </tr>
                  </thead>
